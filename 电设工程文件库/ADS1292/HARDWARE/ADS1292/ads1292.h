...
// ADS1292引脚定义
//-----------------------------------------------------------------
#define DYDR_READ (HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_6))
...
#define ADS1292_CS(n) 	(n?HAL_GPIO_WritePin(GPIOE,GPIO_PIN_9,GPIO_PIN_SET):HAL_GPIO_WritePin(GPIOE,GPIO_PIN_9,GPIO_PIN_RESET))	
#define ADS1292_GPIO1(n) 	(n?HAL_GPIO_WritePin(GPIOE,GPIO_PIN_10,GPIO_PIN_SET):HAL_GPIO_WritePin(GPIOE,GPIO_PIN_10,GPIO_PIN_RESET))		
#define ADS1292_GPIO2(n) 	(n?HAL_GPIO_WritePin(GPIOE,GPIO_PIN_11,GPIO_PIN_SET):HAL_GPIO_WritePin(GPIOE,GPIO_PIN_11,GPIO_PIN_RESET))		
